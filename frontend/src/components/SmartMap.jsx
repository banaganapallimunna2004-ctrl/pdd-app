...
const SmartMap = () => {
  return (
    <div className="overflow-hidden rounded-[32px] border border-white/10 bg-slate-950/70 p-5 shadow-glass">
      <div className="mb-5 flex items-center justify-between text-slate-100">
        <div>
          <p className="text-sm uppercase tracking-[0.3em] text-cyan-300/80">Farm Map</p>
          <h2 className="text-2xl font-semibold">Live location intelligence</h2>
        </div>
      </div>
      <MapContainer center={[34.05, -118.25]} zoom={10} scrollWheelZoom={false} className="h-[420px] w-full rounded-3xl border border-white/10 shadow-2xl">
        <TileLayer
